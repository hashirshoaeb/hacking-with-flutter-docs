...
<MCQ
  ...
  options={[
    { text: "StatefulWidget is faster", hint: "Performance is not the main difference" },
    { text: "StatefulWidget can maintain mutable state", hint: "This is the correct answer" },
    { text: "StatefulWidget has more features", hint: "Both have similar features" },
    { text: "StatefulWidget is newer", hint: "Both have been available since Flutter's inception" },
  ]}
  correctOption={1}
/>
...
<MCQ
  ...
  options={[
    ...
    { text: "didUpdateWidget", hint: "This is called when the widget is rebuilt" },
  ]}
  correctOption={1}
/>
...
<MCQ
  ...
  options={[
    ...
    { text: "To notify Flutter that the widget's state has changed", hint: "This is the correct answer" },
