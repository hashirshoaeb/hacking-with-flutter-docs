...
<MCQ
  ...
  options={[
    { text: "To style form elements", hint: "That's what InputDecoration does" },
    { text: "To manage form state and validation", hint: "This is the correct answer" },
...
<MCQ
  ...
  options={[
    ...
    { text: "To create the input field", hint: "That's what the widget itself does" },
  ]}
  correctOption={2}
/>
