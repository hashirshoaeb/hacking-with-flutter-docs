...
<MCQ
  ...
  options={[
    ...
    { text: "To handle state management", hint: "That's not related to ThemeData" },
...
<MCQ
  ...
  options={[
    { text: "To create animations", hint: "That's not related to LayoutBuilder" },
    { text: "To handle state management", hint: "That's not related to LayoutBuilder" },
    { text: "To adapt layout based on constraints", hint: "This is the correct answer" },
    { text: "To manage navigation", hint: "That's not related to LayoutBuilder" },
  ]}
  correctOption={2}
/>
