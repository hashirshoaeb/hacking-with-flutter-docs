...
<MCQ
  ...
  options={[
    { text: "pushNamed is faster", hint: "Performance is not the main difference" },
    { text: "pushNamed uses predefined routes", hint: "This is the correct answer" },
    { text: "pushNamed can't pass data", hint: "Both can pass data" },
    { text: "pushNamed is newer", hint: "Both have been available since Flutter's inception" },
  ]}
  correctOption={1}
/>
...
<MCQ
  ...
  options={[
    { text: "To create a new screen", hint: "That's what StatelessWidget/StatefulWidget does" },
    { text: "To define the navigation animation and behavior", hint: "This is the correct answer" },
    { text: "To handle state management", hint: "That's what StatefulWidget does" },
