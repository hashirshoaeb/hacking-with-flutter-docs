...
<MCQ
  ...
  options={[
    { text: "StatelessWidget is faster", hint: "Performance is not the main difference" },
    { text: "StatelessWidget can't have children", hint: "StatelessWidget can have children" },
    { text: "StatelessWidget doesn't maintain state", hint: "This is the correct definition" },
    { text: "StatelessWidget can't be styled", hint: "StatelessWidget can be styled" },
  ]}
  correctOption={2}
/>
...
<MCQ
  ...
  options={[
    { text: "To initialize the widget", hint: "That's what the constructor does" },
    { text: "To define the widget's UI structure", hint: "This is the correct definition" },
    { text: "To handle user interactions", hint: "That's handled by callbacks" },
    { text: "To manage the widget's state", hint: "StatelessWidget doesn't manage state" },
  ]}
  correctOption={1}
/>
