...
<MCQ
  ...
  options={[
    { text: "GestureDetector is more performant", hint: "That's not the main difference" },
    { text: "InkWell provides visual feedback", hint: "This is the correct answer" },
    { text: "GestureDetector supports more gestures", hint: "That's not the main difference" },
...
<MCQ
  ...
  options={[
    ...
    { text: "To control animation progress", hint: "This is the correct answer" },
    { text: "To define animation duration", hint: "That's not the main purpose" },
    { text: "To handle gesture events", hint: "That's not related to AnimationController" },
  ]}
  correctOption={1}
/>
