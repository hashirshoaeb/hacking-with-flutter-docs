...
<MCQ
  ...
  options={[
    { text: "To create a new class", hint: "That's what the 'class' keyword does" },
    { text: "To implement an interface", hint: "That's what the 'implements' keyword does" },
    { text: "To inherit from another class", hint: "This is the correct definition" },
...
<MCQ
  ...
  options={[
    { text: "They can be instantiated directly", hint: "Abstract classes cannot be instantiated" },
    { text: "They must implement all methods", hint: "Abstract classes can have abstract methods" },
    { text: "They can have both abstract and concrete methods", hint: "This is the correct definition" },
    { text: "They can only have abstract methods", hint: "Abstract classes can have concrete methods" },
  ]}
  correctOption={2}
/>
...
<MCQ
  ...
  options={[
    { text: "To create new classes", hint: "That's what the 'class' keyword does" },
    { text: "To implement interfaces", hint: "That's what the 'implements' keyword does" },
    { text: "To reuse code across multiple class hierarchies", hint: "This is the correct definition" },
    { text: "To create abstract classes", hint: "That's what the 'abstract' keyword does" },
  ]}
  correctOption={2}
/>
